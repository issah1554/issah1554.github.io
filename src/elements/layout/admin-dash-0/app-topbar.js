  ...
  connectedCallback() {
    ...
    this.innerHTML = /* html */ `
      ...
      <div class="relative">
        ...
        <div
        data-notif-menu
        class="hidden absolute right-0 mt-1 w-72 rounded-2xl border border-main-200 bg-main-100 text-sm text-main-900 shadow-xl z-10"
        >
        ...
        <div class="divide-y divide-main-200">
          <div class="flex items-start gap-3 p-3 hover:bg-main-200 border-b border-main-200 cursor-pointer ">
      ...
      <div class="relative">
        ...
        <a href="/profile" class="flex items-center gap-2 rounded-lg px-3 py-2 text-sm hover:bg-main-200">
